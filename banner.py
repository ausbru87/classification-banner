...
def main():
    ...
    screen.connect("monitors-changed", lambda screen, event: on_configure_event(screen, event, {'bar_size': bar_size, 'window': window}))
    screen.connect("size-changed", lambda screen, event: on_configure_event(screen, event, {'bar_size': bar_size, 'window': window}))
